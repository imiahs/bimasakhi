            ...
            <div className="hero-overlay">
                <div className="hero-inner">
                    ...
                    <div className={`hero-content ${activeIndex === 1 ? "active" : ""}`}>
                        ...
                        <img src="/images/home/hero-visual2.jpg" alt="Empowerment Visual" className="hero-image" />
                        <p className="hero-description">
                    ...
                    <div className={`hero-content ${activeIndex === 2 ? "active" : ""}`}>
                        ...
                        <img src="/images/home/hero-visual3.jpg" alt="Outreach Visual" className="hero-image" />
                        <p className="hero-description">
                    ...
                    <div className={`hero-content ${activeIndex === 3 ? "active" : ""}`}>
                        ...
                        <img src="/images/home/hero-visual4.jpg" alt="Digital Visual" className="hero-image" />
                        <p className="hero-description">
